...
Appeus development tracker. Design decisions live in `docs/DESIGN.md`. Operational docs are in `agent-rules/` and `reference/`.
...
### v2.1: runtime asset compliance review (completed)
